		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atomuiclearingclearingapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atomuiclearingclearingapplication-display": {
								"semanticObject": "atomuiclearingclearingapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=atom.ui.clearing.clearingapplication",
									"url": sap.ui.require.toUrl("atom/ui/clearing/clearingapplication")
								}
							}
						}
					}
